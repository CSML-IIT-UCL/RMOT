...
from rmot_benchmarks import benchmark, my_plot, summary
...
params['regularizations'] = [0.05, 0.02, 0.01, 0.005, 0.001]
...
for p_ in range(pairs):
    ...
    # computing
    dataset['results'] = benchmark(dataset, dual  = True)
