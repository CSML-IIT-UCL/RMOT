...
dataset = dict()
dataset['name'] = 'ModelNet10_extended'
...
params['gpu'] = True
params['sizes'] = [10000, 30000, 50000] if (params['gpu'] and torch.cuda.is_available()) else [1000,3000,5000]
...
for p_ in range(pairs):
    ...
    # plotting results
    my_plot(dataset,plots=['comp_time vs batch'])